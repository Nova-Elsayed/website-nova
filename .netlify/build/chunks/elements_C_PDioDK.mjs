import { _ as __astro_tag_component__, i as Fragment, v as createVNode } from './astro_CyJ2PJMq.mjs';
import '@astrojs/internal-helpers/path';
import './astro/assets-service_RAL9gfjg.mjs';
import { h as humanize, b as $$Image } from './pages/404_RxPL2K7c.mjs';
...
const Button = ({
  ...
  return /* @__PURE__ */ jsx(
    "a",
    {
      ...
      className: `btn mb-4 me-4 hover:text-white dark:hover:text-black hover:no-underline ${style === "outline" ? "btn-outline-primary" : "btn-primary"}`,
      children: label
    }
  );
};
...
const url = "/elements";
const file = "/Users/pdxiii/CODE/website-nova/src/content/pages/elements.mdx";
...
Content.moduleId = "/Users/pdxiii/CODE/website-nova/src/content/pages/elements.mdx";
